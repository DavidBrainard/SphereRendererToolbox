...
viewPoint = [0 0 4*radius];                     %location of point of view
lightSourceCoords = 4*radius*normalize([1 1 1])';     %coordinates of light source
lightSourceFocus = normalize([-1 -1 -1]);   %direction in which source is focussed
